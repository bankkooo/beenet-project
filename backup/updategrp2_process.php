...
<html lang="en">
    ...
    <body>
        <?php
                ...
                $sql2 = "SELECT srvname FROM rm_services WHERE srvid =  $oldsrv_id";
                $sql3 = "SELECT srvname FROM rm_services WHERE srvid =  $newsrv_id";
        ...
        <div class="subheading mb-5 text-center">Update Group 
            <?php echo $row2['srvname'] ?> -> Group <?php echo $row3['srvname']  ?> Completed
        ...
        <div class="row">
                <div class="col text-center">
                    <a class="btn btn-primary" href="updategrp.php" role="button">Back</a>
                </div>
            </div>
